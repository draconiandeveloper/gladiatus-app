...
/**
 * Connect to our MySQL/MariaDB server via UNIX socket files.
 * 
...
class MySQLSock extends Database {
    ...
    public function __construct(string $filename, ?string $username = null, #[\SensitiveParameter] ?string $password = null, ?string $dbname = null) {
        parent::__construct('mysql', $filename, null, $dbname, true, $username, $password);
    }
}